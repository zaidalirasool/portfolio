...
const initialCartItems = [
  {
    ...
    canUnsubscribe: true,
    image: "https://i.imgur.com/6AZR7d6.jpeg",
  },
];

const recommendedItems = [
  { id: 3, name: "Decaf Blend",   size: "12oz (340g)", price: 24.95, image: "https://i.imgur.com/Bjcv82j.jpeg" },
  { id: 4, name: "Single Origin", size: "12oz (340g)", price: 21.21, image: "https://i.imgur.com/f5FmFQs.jpeg" },
];
...
const TOTE_BAG_ITEM = {
  ...
  image: "https://i.imgur.com/k3evBTj.jpeg",
  isToteBag: true,
};
...
export default function RechargeCart() {
  ...
  // Track which item ids have already been rendered so only truly new items get the enter animation.
  const seenItemIdsRef = useRef(new Set(initialCartItems.map(i => i.id)));
  useEffect(() => {
